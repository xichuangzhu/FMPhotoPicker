...
internal var kRedColor = UIColor(red: 1, green: 81/255, blue: 81/255, alpha: 1)
internal var kCheckOnIcon: UIImage = {
    return UIImage.circle(diameter: 26, color: kRedColor)
}()
